...
# myData <- data.frame(
# name= c("Owais Ahmed", "Haris Naseer", "Usama","Afzal"),
# age= c(56, 44, 34,67),
...
# data_frame = data.frame(roll_no,Student_name,profession)
# print(data_frame)
...
# Plotting Character (point shape).
...
# Yahan points diamond shape me dikhain ge.

# 4. cex = 1

# Point size control karta hai.
...
# "l" → sirf lines
# "b" → points + lines
# "o" → points aur lines overplotted (ek dusre ke upar)
